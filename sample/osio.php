...
　　　　 <td width="45" >選択</td>
        ...
        <tr>
                <td><input class="check" type="checkbox" style="width:40px;height:40px;" name="選択[]"><td height="45"></td>
                <td></td>
                <td></td>
                <td></td>
                </tr>
                ...
                <tr>
                <td><input class="check" type="checkbox" style="width:40px;height:40px;" name="選択[]"><td height="45"></td></td>
                <td></td>
                <td></td>
                <td></td>
                </tr>                         
        ...
        <p>
                ...
                <input id="btn" type="button" disabled="disablad" onclick=location.href="http://yume.hacca.jp/koiki/form/button-link.htm" value="売値表示" style="width:200px;height:50px;font-size:25px">
